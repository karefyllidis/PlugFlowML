...
- **`HYDRAI_NOTEBOOK_ARCHITECTURE.mdc`**: Cursor rule — **Main_1–Main_7** pipeline order, data prerequisites, config ownership, **section maps**, stable artefact names; keep in sync when adding or renaming pipeline notebooks.
