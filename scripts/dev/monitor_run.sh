#!/bin/bash
# Live snapshot of a running HydrAI SLURM data-generation job.
# Run from repo root at any time during or after the job:
#   bash scripts/dev/monitor_run.sh
#
# Optional: watch mode (refresh every 30 s):
#   watch -n 30 "bash scripts/dev/monitor_run.sh"
