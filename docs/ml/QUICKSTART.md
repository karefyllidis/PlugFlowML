...
**Smoke vs full data:** In Main_3 Section 2, `RUN_STAMP = RUN_STAMP_DEVEL` loads small `training_data_complete_20260507_DEVEL.pkl` for quick checks; use `RUN_STAMP_FULL` or `IF_PIN_SPECIFIC_FILES = False` before exporting `features_targets_*_095243.pkl` for Main_4–7.
