...
- **Docs** — `README.md`, `docs/ML_CONFIG_GUIDE.md`, `docs/STRUCTURE.md`, `docs/DIRECTORY_STRUCTURE.md`, and `.cursor/rules/HYDRAI_NOTEBOOK_ARCHITECTURE.mdc` updated for Main_6 / Main_7 **Jupyter live** convergence + Optuna dashboards, **`LIVE_*_PLOT_EVERY`** throttling, Main_7 **Overfitting controls used here** overview (aligned with Main_6), and throughput flags (`USE_CUDA_AMP`, `USE_TORCH_COMPILE`, `OPTUNA_N_JOBS`).
