...
**Purpose**: Document colours used across `notebooks/Main_*.ipynb` and the **preferred palette for new work**. Palette standards are documented in §5.10 of this file.
